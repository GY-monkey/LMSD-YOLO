...
sets = ['train', 'test', 'val']
classes = ['ship']  #define your classes

def parse_opt():
    parser = argparse.ArgumentParser()
    parser.add_argument('--path', type=str, default='/home/atr2/data/SAR_SHIP_SSDD', help='data path')
...
for image_set in sets:
    ...
    image_ids = open(opt.path + '/ImageSets/Main/%s.txt' % (image_set)).read().strip().split()
